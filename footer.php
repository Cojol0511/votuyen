  ...
  <div class="container d-flex flex-lg-row flex-column-reverse justify-content-between">
    <div class="fLeft">
      <div class="d-flex">
        <a href="<?php echo home_url(); ?>/">
          <img style="width: 32px;height: 32px;" src="<?php bloginfo('template_directory'); ?>/assets/images/logo.png"
            alt="" class="logo me-2">
        </a>
    ...
    <div class="fRight d-flex align-items-center ">
      <ul class="fNav d-flex justify-content-lg-between">
        ...
        <li><a data-navurl="company" class="green-co green-co-hv" href="<?php echo home_url(); ?>/company">会社概要</a></li>
        <li><a data-navurl="contact" class="blue-co blue-co-hv" href="<?php echo home_url(); ?>/contact">問い合わせ</a></li>
      </ul>
    </div>
  </div>
</div>
