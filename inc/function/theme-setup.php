...
function wph_scripts()
{
    ...
    wp_enqueue_style('hieu-css', $uri . '/assets/css/hieu_style.css?v=' . time(), array(), false, 'all');
    ...
    wp_enqueue_script('custom-js', $uri . '/assets/js/main.js', array('jquery'), false, true);
}
