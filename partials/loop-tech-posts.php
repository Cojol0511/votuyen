...
<section class="banner-tech-info">
  <img src="<?php bloginfo('template_directory'); ?>/assets/images/Banner-tech-posts.jpg" class="w-100" alt="">
</section>
        ...
        <div class="post-item border ">
          <div class="d-flex">
            ...
            <div class="content">
              ...
              <p class="see-detail "><a href="<?php echo get_permalink() ?>" class="current-page text-black">もっと見る></a>
              </p>
            </div>
          </div>
        </div>
