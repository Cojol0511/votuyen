        ...
        <div class="row">
          ...
          <div class="col-3">
            <div class="menu">
              <ul>
                <li>
                  <h2 class="text-menu">EcoTx315A1</h2>
                </li>
                <li>
                  <h2 class="text-menu">EcoTx426A1</h2>
                </li>
                <li>
                  <h2 class="text-menu">EcoTx429A1</h2>
                </li>
                <li>
                  <h2 class="text-menu">EcoTx920A1</h2>
                </li>
                <li>
                  <h2 class="text-menu">EcoTx2.4G1</h2>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-4">
            <div class="menu">
              <ul>
                ...
                <li>
                  <h2 class="text-menu">受信機型番: InRx01</h2>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="img-bottom">
              <img class="product-img"
                src="<?php bloginfo('template_url'); ?>/assets/images/page-product/remote-control-part4-bottom.png"
                alt="">
            </div>
          </div>
        </div>
